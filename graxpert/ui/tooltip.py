...
deconvolution_apply_luminance_only_text = _("If enabled, the deconvolution will be applied only to the luminance channel, leaving the chrominance channels unchanged.")
